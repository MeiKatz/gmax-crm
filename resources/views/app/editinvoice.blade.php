    ...
    <div class="row">
        <div class="col-md-3">
            <div class="dropdown-menu dropdown-menu-demo">
                ...
                <form method="post" action="{{ route('invoices.send-email', [ $invoice ]) }}" onsubmit="return confirm('Are you sure?')">
                  @csrf
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                          ...
                          @endphp
                            <tr>
                                  <td class="text-muted">
                                    <input form="{{ $formId }}" class="form-control form-control-sm" type="text" value="{{$invoiceItem->meta}}" name="meta" placeholder="Particular" /></td>
                                  <td class="text-muted">
